...
type StatefulSkillMode = 'deep-interview' | 'autopilot' | 'goal-harness' | 'ralph' | 'ralplan' | 'ultragoal' | 'ultrawork' | 'ultraqa' | 'team' | 'autoresearch';
...
const STATEFUL_SKILL_SEED_CONFIG: Record<StatefulSkillMode, StatefulSkillSeedConfig> = {
  ...
  'goal-harness': { mode: 'goal-harness', initialPhase: 'intake' },
