...
**Документація:** [Початок роботи](./docs/getting-started.html) · [Агенти](./docs/agents.html) · [Навички](./docs/skills.html) · [Інтеграції](./docs/integrations.html) · [Demo](./DEMO.md) · [Посібник OpenClaw](./docs/openclaw-integration.md)
...
- запуск потужнішої сесії Codex за замовчуванням
- виконання єдиного послідовного робочого процесу від уточнення до завершення
- виклик канонічних навичок через `$deep-interview`, `$ralplan`, `$team` і `$ralph`
- збереження керівних принципів проєкту, планів, журналів і стану в `.omx/`
...
- [Посібник OpenClaw / шлюзу сповіщень](./docs/openclaw-integration.md)
...
| Супровідник | HaD0Yun | [@HaD0Yun](https://github.com/HaD0Yun) |
